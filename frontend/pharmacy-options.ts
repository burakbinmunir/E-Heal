...
@customElement('pharmacy-options')
export class PharmacyOptions extends LitElement {
  static get styles() {
    return css`
      :host {
          display: block;
...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-vertical-layout class="content" style="width: 100%; flex-grow: 1; flex-shrink: 1; flex-basis: auto;">
  <vaadin-horizontal-layout theme="spacing" style="align-self: stretch;">
   <vaadin-vertical-layout theme="spacing" id="viewOrdersLayout"></vaadin-vertical-layout>
