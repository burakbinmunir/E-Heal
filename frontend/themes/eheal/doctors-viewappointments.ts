...
@customElement('doctors-viewappointments')
export class DoctorsViewappointments extends LitElement {
  static get styles() {
    return css`
      :host {
          display: block;
...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-vertical-layout class="content" style="width: 100%; flex-grow: 1; flex-shrink: 1; flex-basis: auto;" id="vaadinVerticalLayout">
  <label style="align-self: center; padding: var(--lumo-space-m);">Scheduled Appointments</label>
