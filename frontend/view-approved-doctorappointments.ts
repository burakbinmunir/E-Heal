...
@customElement('view-approved-doctorappointments')
export class ViewApprovedDoctorappointments extends LitElement {
  static get styles() {
    return css`
      :host {
          display: block;
...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-vertical-layout class="content" style="width: 100%; flex-grow: 1; flex-shrink: 1; flex-basis: auto;">
  <label style="align-self: center; padding: var(--lumo-space-m);">Here are your approved appointments</label>
  <vaadin-horizontal-layout theme="spacing" id="gridLayout" style="align-self: stretch;"></vaadin-horizontal-layout>
